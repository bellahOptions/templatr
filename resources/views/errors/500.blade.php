...
<head>
    ...
    <title>500 - Server Error | Templatr</title>
...
<body>
    ...
    <div class="container">
        <h1>500</h1>
        <p class="subtitle">Server Error</p>
        <p class="desc">Something went wrong on our end. We're working on it. Please try again later.</p>
        <div class="btn-group">
