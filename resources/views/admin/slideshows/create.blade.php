...
@section('title', 'Add Slide - Templatr')
@section('header', 'Add Slide')

@section('content')
<div class="max-w-2xl mx-auto">
    <div class="bg-white border border-gray-200 rounded-2xl p-8">
        <form method="POST" action="{{ route('admin.slideshows.store') }}" enctype="multipart/form-data" class="space-y-6">
            @csrf
            ...
            <div>
                ...
                <p class="text-xs text-gray-400 mt-1">Recommended: 1920×1080px, max 5MB (JPEG, PNG, WebP)</p>
            ...
            <div>
                ...
                <input type="text" name="title" value="{{ old('title') }}" required
                       ...
                       placeholder="e.g. Get Premium Creative Resources">
            ...
            <div>
                ...
                <textarea name="description" rows="3"
                          class="w-full px-4 py-3 border border-gray-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#FFC300]"
                          placeholder="Short description shown below the title">{{ old('description') }}</textarea>
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="cta_url" value="{{ old('cta_url', '/products') }}"
                           class="w-full px-4 py-3 border border-gray-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#FFC300]"
            ...
            <div class="flex items-center justify-end space-x-3 pt-4 border-t border-gray-200">
                ...
                <button type="submit" class="px-6 py-3 bg-black text-white rounded-xl text-sm font-semibold hover:bg-gray-800">Create Slide</button>
            </div>
        </form>
    </div>
</div>
